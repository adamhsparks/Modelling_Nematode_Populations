---
title: "Fitting Linear and Quadratic Models of Nematode Populations Responses to Time and Temperature"
...
This document recreates the models for population densities of *Pratylenchus
thornei* described in _Modelling population densities of root-lesion nematode
(_P. thornei_) from soil profile temperatures to choose an optimum sowing date
for wheat_ (Thompson 2015).

There are two models described in the paper, the first model is a linear model
used to describe the unplanted control and the quadratic models fit Gatcher
(Susceptible) and GS50a (Moderately Resistant) wheat cultivars.
